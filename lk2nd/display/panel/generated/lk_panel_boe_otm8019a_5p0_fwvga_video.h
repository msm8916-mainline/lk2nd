							     ...
							     struct mdss_dsi_phy_ctrl *phy_db)
{
	...
	pinfo->mipi.panel_on_cmds = boe_otm8019a_5p0_fwvga_video_on_command;
	pinfo->mipi.panel_off_cmds = boe_otm8019a_5p0_fwvga_video_off_command;
	pinfo->mipi.num_of_panel_on_cmds = ARRAY_SIZE(boe_otm8019a_5p0_fwvga_video_on_command);
	pinfo->mipi.num_of_panel_off_cmds = ARRAY_SIZE(boe_otm8019a_5p0_fwvga_video_off_command);
