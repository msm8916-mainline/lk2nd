							      ...
							      struct mdss_dsi_phy_ctrl *phy_db)
{
	...
	pinfo->mipi.panel_off_cmds = cmi_nt35532_5p5_1080pxa_video_off_command;
	pinfo->mipi.num_of_panel_on_cmds = ARRAY_SIZE(cmi_nt35532_5p5_1080pxa_video_on_command);
	pinfo->mipi.num_of_panel_off_cmds = ARRAY_SIZE(cmi_nt35532_5p5_1080pxa_video_off_command);
